#!/usr/bin/env python3
# 90% code  references website "https://github.com/brucefan1983/GPUMD/tree/master", author just add the stress_extract information .
...
if __name__ == "__main__":
    ...
    write_xyz("original-stress.xyz", pos_data, forces_list, energies, lattices, stresses_list)
